      ...
      <a-card :bordered="false">
        ...
        <a-modal v-model="showAddForm" footer="">
          ...
          {rules: [{ required: true, message: '请选择器材名称' }]}
                ...
                placeholder="请选择器材名称"
              >
                <a-select-option v-for="(item,index) in this.allEquipType" :key="index" :value="item">{{item}}
                </a-select-option>
              </a-select>
            </a-form-item>
            <a-form-item
          ...
          {rules: [{ required: true, message: '请选择所属仓库' }]}
                ...
                placeholder="请选择所属仓库"
              >
                <a-select-option v-for="(item,index) in this.allWarehouse" :key="index" :value="item">{{item}}
                </a-select-option>
              </a-select>
            </a-form-item>
