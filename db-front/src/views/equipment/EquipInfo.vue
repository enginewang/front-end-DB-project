<template>
  <page-view :title="IDTitle"
    ...
    <a-row :gutter="24">
      <a-col :md="24"
             :lg="7">
        <a-card style="margin-top: 0px; font-size: medium"
                :bordered="true">
        ...
        <a-card style="margin-top: 0px; font-size: medium"
          ...
          <detail-list title="详情栏"
            ...
            <detail-list-item term="">
              <a-icon type="qrcode" />（扫描右侧二维码查看详情）</detail-list-item>
          </detail-list>
